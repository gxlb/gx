...
//for sort
type treeNodeSortSlice []*FileHashTreeNode
...
//data
func (this *treeNodeSortSlice) D() []*FileHashTreeNode {
	return *this
}

//push
func (this *treeNodeSortSlice) Push(v *FileHashTreeNode) int {
	*this = append(*this, v)
	return this.Len()
}

func (this *treeNodeSortSlice) Pop() (r *FileHashTreeNode) {
	if len(*this) > 0 {
		r = (*this)[len(*this)-1]
	}
