...
type FileHashTreeNode struct {
	FileHash
	children _FileHashTreeNodeSortSlice
}
...
//for sort
type _FileHashTreeNodeSortSlice []*FileHashTreeNode

func (this *_FileHashTreeNodeSortSlice) Sort() {
	sort.Sort(this)
}

//data
func (this *_FileHashTreeNodeSortSlice) Buffer() []*FileHashTreeNode {
	return *this
}

//push
func (this *_FileHashTreeNodeSortSlice) Push(v *FileHashTreeNode) int {
	*this = append(*this, v)
	return this.Len()
}

func (this *_FileHashTreeNodeSortSlice) Pop() (r *FileHashTreeNode) {
	if len(*this) > 0 {
		r = (*this)[len(*this)-1]
	}
...
//len
func (this *_FileHashTreeNodeSortSlice) Len() int {
	return len(this.Buffer())
}

//sort by Hash decend,the larger one first
func (this *_FileHashTreeNodeSortSlice) Less(i, j int) (ok bool) {
	l, r := (*this)[i], (*this)[j]
...
//swap
func (this *_FileHashTreeNodeSortSlice) Swap(i, j int) {
