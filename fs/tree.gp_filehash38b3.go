...
// Last update at: [Sat Nov 05 2016 15:02:13]
// Generate from:
...
//#GOGP_REQUIRE(github.com/vipally/gx/stl/gp/sort_slice,tree_sort_slice2)

func init() {
	gFileHashTreeGbl.cmp = gFileHashTreeGbl.cmp.CreateByName("Greater")
}

var gFileHashTreeGbl struct {
	cmp CmpFileHash
}
...
//new container
func NewFileHashTree(bigFirst bool) *FileHashTree {
	p := &FileHashTree{cmp: gFileHashTreeGbl.cmp.CreateByBool(bigFirst)}
	return p
}
...
//	l, r := (*this)[i], (*this)[j]
//	return gFileHashTreeGbl.cmp.F(l.FileHash, r.FileHash)
//}
