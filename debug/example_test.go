...
//import "github.com/vipally/gx/debug"
func ExampleBt() {
	//example begin
	fmt.Println(debug.Bt())
	fmt.Println(debug.Bts())
	// Output :
	//Func{github.com/vipally/gx/debug_test.ExampleBt} FileLine{F:/dev/gocode/src/github.com/vipally/gx/debug/example_test.go : 11} pc{42C1DE}
	//#0 Func{github.com/vipally/gx/debug_test.ExampleBt} File{F:/dev/gocode/src/github.com/vipally/gx/debug/example_test.go : 12} pc{42C24F}
	...
	//#4 Func{main.main} File{C:/DOCUME~1/ally/LOCALS~1/Temp/go-build973468619/github.com/vipally/gx/debug/_test/_testmain.go : 48} pc{401180}
