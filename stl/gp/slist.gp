...
func (this *<GLOBAL_NAME_PREFIX>SListNode) Get() <VALUE_TYPE> {
	return this.#GOGP_RAWNAME(<VALUE_TYPE>)
}

func (this *<GLOBAL_NAME_PREFIX>SListNode) Set(v <VALUE_TYPE>) (old <VALUE_TYPE>) {
	old, this.#GOGP_RAWNAME(<VALUE_TYPE>) = this.#GOGP_RAWNAME(<VALUE_TYPE>), v
	return
}
...
func (this *<GLOBAL_NAME_PREFIX>SList) PushFront(v <VALUE_TYPE>) *<GLOBAL_NAME_PREFIX>SListNode {
	n := &<GLOBAL_NAME_PREFIX>SListNode{#GOGP_RAWNAME(<VALUE_TYPE>): v, next: this.head.next}
	this.head.next = n
	//#GOGP_IFDEF GOGP_HasTail
	if this.tail == nil {
		this.tail = n
...
func (this *<GLOBAL_NAME_PREFIX>SList) PushBack(v <VALUE_TYPE>) *<GLOBAL_NAME_PREFIX>SListNode {
	n := &<GLOBAL_NAME_PREFIX>SListNode{#GOGP_RAWNAME(<VALUE_TYPE>): v}
	if this.tail != nil {
		this.tail.next = n
	} else {
		this.head.next = n
...
func (this *<GLOBAL_NAME_PREFIX>SList) PushAfter(v <VALUE_TYPE>, mark *<GLOBAL_NAME_PREFIX>SListNode) (n *<GLOBAL_NAME_PREFIX>SListNode) {
	if mark != nil {
		n = &<GLOBAL_NAME_PREFIX>SListNode{#GOGP_RAWNAME(<VALUE_TYPE>): v, next: mark.next}
...
func (this *<GLOBAL_NAME_PREFIX>SList) merge(other *<GLOBAL_NAME_PREFIX>SList) {
	...
	for p.next != nil && po != nil {
		pn := p.next
		if g<GLOBAL_NAME_PREFIX>SListGbl.cmp.F(po.#GOGP_RAWNAME(<VALUE_TYPE>), pn.#GOGP_RAWNAME(<VALUE_TYPE>)) {
			n := other.RemoveFront()
			po = other.Front()
