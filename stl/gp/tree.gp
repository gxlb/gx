...
func (this *<GLOBAL_NAME_PREFIX>TreeNode) Less(right *<GLOBAL_NAME_PREFIX>TreeNode) (ok bool) {
	...
	ok = this.#GOGP_RAWNAME(<VALUE_TYPE>).Less(right.#GOGP_RAWNAME(<VALUE_TYPE>))
	//#GOGP_ELSE
	ok = this.#GOGP_RAWNAME(<VALUE_TYPE>) < right.#GOGP_RAWNAME(<VALUE_TYPE>)
	//#GOGP_ENDIF
	return
}
...
func (this *<GLOBAL_NAME_PREFIX>TreeNode) AddChild(v <VALUE_TYPE>, idx int) (child *<GLOBAL_NAME_PREFIX>TreeNode) {
	n := &<GLOBAL_NAME_PREFIX>TreeNode{#GOGP_RAWNAME(<VALUE_TYPE>): v}
...
func (this *<GLOBAL_NAME_PREFIX>TreeNode) All() (list []<VALUE_TYPE>) {
	list = append(list, this.#GOGP_RAWNAME(<VALUE_TYPE>))
...
func (this *<GLOBAL_NAME_PREFIX>TreeNodeVisitor) Get() (data *<VALUE_TYPE>) {
	if nil != this.node {
		data = &this.node.#GOGP_RAWNAME(<VALUE_TYPE>)
	}
	return
}
