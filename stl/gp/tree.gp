...
// Generate from:
//   [github.com/vipally/gx/stl/tree.go]
//   [github.com/vipally/gx/stl/stl.gpg] [GOGP_REVERSE_tree]
//
...
//for sort
type treeNodeSortSlice []*<TREE_NAME_PREFIX>TreeNode
...
//data
func (this *treeNodeSortSlice) D() []*<TREE_NAME_PREFIX>TreeNode {
	return *this
}

//push
func (this *treeNodeSortSlice) Push(v *<TREE_NAME_PREFIX>TreeNode) int {
	*this = append(*this, v)
	return this.Len()
}

func (this *treeNodeSortSlice) Pop() (r *<TREE_NAME_PREFIX>TreeNode) {
	if len(*this) > 0 {
		r = (*this)[len(*this)-1]
	}
