...
func init() {
	g<GLOBAL_NAME_PREFIX>TreeGbl.cmp = GetCmpFunc<GLOBAL_NAME_PART>("#GOGP_GPGCFG(GOGP_DefaultCmpType)")
}

var g<GLOBAL_NAME_PREFIX>TreeGbl struct {
	cmp CmpFunc<GLOBAL_NAME_PART>
}
...
func New<GLOBAL_NAME_PREFIX>Tree(cmpType string) *<GLOBAL_NAME_PREFIX>Tree {
	p := &<GLOBAL_NAME_PREFIX>Tree{cmp: g<GLOBAL_NAME_PREFIX>TreeGbl.cmp}
	if cmpType != "" {
		p.cmp = GetCmpFunc<GLOBAL_NAME_PART>(cmpType)
	}
	return p
}
...
func (this *__<GLOBAL_NAME_PREFIX>TreeNodeSortSlice) Less(i, j int) (ok bool) {
	l, r := (*this)[i], (*this)[j]
	return g<GLOBAL_NAME_PREFIX>TreeGbl.cmp(l.<VALUE_TYPE>, r.<VALUE_TYPE>)
}
