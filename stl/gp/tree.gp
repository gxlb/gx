...
func init() {
	g<GLOBAL_NAME_PREFIX>Gbl.cmp = CreateComparer<GLOBAL_NAME_PART>("#GOGP_GPGCFG(GOGP_DefaultCmpType)")
}

var g<GLOBAL_NAME_PREFIX>Gbl struct {
...
//new container
func New<GLOBAL_NAME_PREFIX>Tree(cmpType string) *<GLOBAL_NAME_PREFIX>Tree {
	p := &<GLOBAL_NAME_PREFIX>Tree{cmp: g<GLOBAL_NAME_PREFIX>Gbl.cmp}
	if cmpType != "" {
		p.cmp = CreateComparer<GLOBAL_NAME_PART>(cmpType)
	}
	return p
}
...
type <GLOBAL_NAME_PREFIX>TreeNode struct {
	<VALUE_TYPE>
	children __<GLOBAL_NAME_PREFIX>TreeNodeSortSlice
}
...
func (this *__<GLOBAL_NAME_PREFIX>TreeNodeSortSlice) Less(i, j int) (ok bool) {
	l, r := (*this)[i], (*this)[j]
	return g<GLOBAL_NAME_PREFIX>Gbl.cmp.F(l.<VALUE_TYPE>, r.<VALUE_TYPE>)
}
