...
type <GLOBAL_NAME_PREFIX>ListNodeVisitor struct {
	node, head *<GLOBAL_NAME_PREFIX>ListNode
}

func (this *<GLOBAL_NAME_PREFIX>ListNodeVisitor) Reset() {
	this.node = nil
}

func (this *<GLOBAL_NAME_PREFIX>ListNodeVisitor) Next() (ok bool) {
	if this.node == nil {
...
func (this *<GLOBAL_NAME_PREFIX>ListNodeVisitor) Prev() (ok bool) {
	if this.node == nil {
		if ok = this.head != nil; ok {
...
func (this *<GLOBAL_NAME_PREFIX>ListNodeVisitor) Get() *<GLOBAL_NAME_PREFIX>ListNode {
	return this.node
}

func (this *<GLOBAL_NAME_PREFIX>List) Visitor() *<GLOBAL_NAME_PREFIX>ListNodeVisitor {
	n := &<GLOBAL_NAME_PREFIX>ListNodeVisitor{node: nil, head: this.head}
	return n
}
...
func (this *<GLOBAL_NAME_PREFIX>List) PushFront(v <VALUE_TYPE>) *<GLOBAL_NAME_PREFIX>ListNode {
	n := &<GLOBAL_NAME_PREFIX>ListNode{val: v}
...
func (this *<GLOBAL_NAME_PREFIX>List) merge(other *<GLOBAL_NAME_PREFIX>List) {
	...
	for p != nil && po != nil {
		if g<GLOBAL_NAME_PREFIX>ListGbl.cmp.F(po.val, p.val) {
			n := other.RemoveFront()
			po = other.Front()
