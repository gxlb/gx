...
// Last update at: [Wed Oct 12 2016 23:13:09]
// Generate from:
//   [github.com/vipally/gx/stl/sort_slice.go]
//   [github.com/vipally/gx/stl/stl.gpg] [GOGP_REVERSE_sort_slice]
//
...
func (this *<SLICE_NAME_PREFIX>SortSlice) Less(i, j int) bool {
	l, r := (*this)[i], (*this)[j]
	return l.Less(r)
}
